...
\subsection{Delete}
The \emph{delete} operation removes a subset of elements from a base entity set and the corresponding dependent subsets from any dependent entity sets, cascading recursively down the chains of dependencies.
...
Individual delete operations are always atomic, no matter how many elements are deleted and how downstream they cascade.
...
\subsection{Matching attributes}
...
Entity \lstinline$U$ (Section \ref{sec:u} provides a mechanism to force matching attributes that do not have a common origin.
