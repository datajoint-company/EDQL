...
Since SQL is the effective lingua franca in the world of relational databases, some examples and discussions will explicitly highlight the principal conceptual weaknesses of SQL that are resolved with \datajoint.
...
\datajoint consists of a schema definition language, a data query language, and diagramming notation for visualizing relationships between data elements. 

The central concept of the \datajoint data model is that of an \emph{entity set}. 
...
In this section, we will describe the \emph{schema definition language} of \datajoint.
